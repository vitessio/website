...
# Usage: VITESS_DIR=/full/path/to/vitess.io/vitess make query_analyzer-docs
query_analyzer-docs:
	go run ./tools/cobradocs/ --vitess-dir "${VITESS_DIR}" --version-pairs "${COBRADOC_VERSION_PAIRS}" query_analyzer
