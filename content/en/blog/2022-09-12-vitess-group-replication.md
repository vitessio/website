...
_Update June 12, 2023_: This component has been deprecated in v17 and will be removed in v18! We recommend that you instead use [VTOrc](../../docs/user-guides/configuration-basic/vtorc/) with the [semi_sync durability policy](../../docs/user-guides/configuration-basic/durability_policy/).
