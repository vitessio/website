...
* We migrated <code>[vtadmin-web](https://vitess.io/docs/17.0/reference/command-line-reference/vtadmin-web/)</code> from `create-react-app` to <code>[Vite](https://vitejs.dev/)</code> which allows us to easily keep dependencies up to date and vulnerability-free.
