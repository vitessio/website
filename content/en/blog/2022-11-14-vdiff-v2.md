...
* [`vtctld`](https://vitess.io/docs/reference/command-line-reference/vtctld/)
...
* In [`vtctld`](https://vitess.io/docs/reference/command-line-reference/vtctld/) : stream the results from those SELECTs, doing a
...
* On the source and target [tablets](https://vitess.io/docs/concepts/tablet/): close the open transaction with
  a `ROLLBACK`
* Finally the [`vtctl`](https://vitess.io/docs/reference/command-line-reference/vtctl/) client prints a report (to STDOUT) of the
  results
...
* Synchronous command — the vtctl client command would block until the VDiff completed which posed some challenges and
  ...
  call
* VTCtld as the controller — the [Vitess cluster management daemon](https://vitess.io/docs/reference/command-line-reference/vtctld/) is
