---
title: Vitess 6 Local Install (Preview)
description: Instructions for using Vitess 6.0 on your machine for testing purposes
weight: 5
---

{{< info >}}
This guide shows instructions for a pre-release of Vitess.
{{< /info >}}
