...
{{< info >}}
This guide follows on from [Vertical Split](../../user-guides/historical/vertical-split) and [Get Started with a Local deployment](../docs/get-started/local). It assumes that several scripts have been executed, and that you have a running Vitess cluster.
{{< /info >}}
