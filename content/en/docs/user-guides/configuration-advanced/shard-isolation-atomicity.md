...
Here is our example for this case using `vtexplain` and (`method2.sh`)[https://github.com/vitessio/vitess/blob/main/examples/local/vtexplain_atomicity_method2.sh]:
...
Let's run our example for this case (`method3.sh`)[https://github.com/vitessio/vitess/blob/main/examples/local/vtexplain_atomicity_method3.sh] and inspect the output:
