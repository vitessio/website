...
* During resharding, Vitess uses GTIDs for [VReplication](../docs/reference/vreplication), the process by which source tablet data is transferred to the proper destination tablets.
