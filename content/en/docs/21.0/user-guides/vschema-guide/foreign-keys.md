...
To fix the schema, we should change the reference action of one of the foreign keys. Changing the foreign key in t3 referencing t2 to use` ON UPDATE RESTRICT` will prevent cycles
