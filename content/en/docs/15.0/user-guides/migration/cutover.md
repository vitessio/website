...
```
vtctlclient --server vtctld.host:1599- SwitchReads -- --tablet_types=rdonly targetkeyspace.workflowname
```

- REPLICA:  

```
vtctlclient --server vtctld.host:1599- SwitchReads -- --tablet_types=replica targetkeyspace.workflowname
```
