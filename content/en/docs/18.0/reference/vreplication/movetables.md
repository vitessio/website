...
During `Complete` or `Cancel` operations, Preserves the original source table data that was duplicated during the MoveTables workflow, which can be beneficial for data validation or other purposes.
