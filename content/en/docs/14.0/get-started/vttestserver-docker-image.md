...
This guide covers using the vttestserver docker image for testing purposes. This is also the docker image that we use for testing in [Vitess Framewok Testing](https://github.com/janpio/vitess-framework-testing).
