...
[`LookupVindex`](../../../reference/command-line-reference/vtctldclient/vtctldclient_lookupvindex/) is a command used to create **and** backfill
...
Please see the [`LookupVindex` command reference](../../../reference/command-line-reference/vtctldclient/vtctldclient_lookupvindex/) for a full list of sub-commands and their flags.
