...
You can create keyspaces and shards using [vtctldclient](../../../reference/command-line-reference/vtctldclient) commands. However, they are not necessary because these are implicitly created as you bring up the vttablets.
...
Tools like [vtgate](../../../reference/command-line-reference/vtgate) and [vttablet](../../../reference/command-line-reference/vttablet) consume information from the local copy of the topo.
