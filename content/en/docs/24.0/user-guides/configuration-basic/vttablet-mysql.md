...
* Perform a [RebuildKeyspaceGraph](../../../reference/command-line-reference/vtctl/keyspaces/#rebuildkeyspacegraph) to deploy the global topo to the current cell (cell1).
