...
[CellAlias](https://vitess.io/docs/reference/command-line-reference/vtctl/cell-aliases/) that contain a list of cells using the `--cells` flag in your VReplication
