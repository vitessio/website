...
* The [vtctl GenerateShardRanges](../../../reference/command-line-reference/vtctl/shards/#generateshardranges) command-line tool supports generating shard ranges based on the provided number of shards.
* There are additional [Shard specific vtctl](../../../reference/command-line-reference/vtctl/shards) command-line tools. 
