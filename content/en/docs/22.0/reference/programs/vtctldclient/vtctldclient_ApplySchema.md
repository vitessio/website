...
--ddl-strategy is used to choose migration strategy such as `vitess`, `mysql` or `direct`, with optional parameters.
...
```
      ...
      --ddl-strategy string              Online DDL strategy, compatible with @@ddl_strategy session variable (examples: 'mysql', 'vitess --postpone-completion'. (default "direct")
