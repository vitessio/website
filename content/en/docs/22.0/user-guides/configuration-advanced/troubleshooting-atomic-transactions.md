...
1. Obtain detailed information about the transaction using its dtid by running the `GetTransactionInfo` RPC command. Further details about this command can be found [here](../../../reference/programs/vtctldclient/vtctldclient_distributedtransaction/vtctldclient_distributedtransaction_get-info).
