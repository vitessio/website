...
* even for a single stream, if the server is of a lower configuration, then the resulting increase in the qp or binlog increase may become significant as a percentage of resources
