---
title: The VTExplain Tool
---

The `vtexplain` tool provides information about how Vitess will execute a statement (the Vitess version of MySQL's `EXPLAIN` command).

## Prerequisites

You'll need to build the `vtexplain` binary in your environment.
To find instructions on how to build this binary please refer to this [guide](../../getting-started/local-instance#manual-build). 
